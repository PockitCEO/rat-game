    ...
    solidityModuleResolver = (moduleName, ts, createInfo, containingFile) => {
      if (isRelativeSolidity(moduleName)) {
        return {
          ...
          resolvedFileName: path__default.default.resolve(path__default.default.dirname(containingFile), moduleName)
        };
      }
      if (isSolidity(moduleName)) {
        return {
          extension: ts.Extension.Dts,
          isExternalLibraryImport: false,
          resolvedFileName: module$1.createRequire(path__default.default.dirname(containingFile)).resolve(moduleName)
        };
      }
