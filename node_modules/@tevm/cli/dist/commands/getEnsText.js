...
export default function GetEnsText({ options }) {
    // Use the action hook
    ...
    return (_jsx(CliAction, { ...actionResult, targetName: `${actionResult.options['key'] || 'url'} record for ${actionResult.options['name'] || 'vitalik.eth'}`, successMessage: "ENS text record retrieved successfully!" }));
}
