...
export default function CreateBlockFilter({ options }) {
    // Use the action hook
    const actionResult = useAction({
        ...
        createParams: (_enhancedOptions) => {
            return {};
        },
        // Execute the action
        executeAction: async (client, _params) => {
    ...
    return _jsx(CliAction, { ...actionResult, targetName: "block filter", successMessage: "Block filter created successfully!" });
}
