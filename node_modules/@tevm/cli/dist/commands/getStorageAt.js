...
export default function GetStorageAt({ options }) {
    // Use the action hook
    ...
    return (_jsx(CliAction, { ...actionResult, targetName: `storage slot ${actionResult.options['slot'] || '0x0'} at ${actionResult.options['address'] || '0x0000...0000'}`, successMessage: "Storage value retrieved successfully!" }));
}
