...
export default function GetBlockNumber({ options }) {
    // Use the action hook
    ...
    return (_jsx(CliAction, { ...actionResult, targetName: "current block number", successMessage: "Block number retrieved successfully!" }));
}
