...
export default function CreateEventFilter({ options }) {
    // Use the action hook
    ...
    return (_jsx(CliAction, { ...actionResult, targetName: `${actionResult.options['eventName'] || 'all'} events on ${actionResult.options['address'] || '0x0000...0000'}`, successMessage: "Event filter created successfully!" }));
}
