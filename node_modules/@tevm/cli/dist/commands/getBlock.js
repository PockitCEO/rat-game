...
export default function GetBlock({ options }) {
    // Use the action hook
    ...
    return (_jsx(CliAction, { ...actionResult, targetName: targetDesc, successMessage: "Block information retrieved successfully!" }));
}
