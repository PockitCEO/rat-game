...
export default function GetTransaction({ options }) {
    // Use the action hook
    ...
    return (_jsx(CliAction, { ...actionResult, targetName: `transaction ${actionResult.options['hash'] ? `${actionResult.options['hash'].substring(0, 10)}...` : '0x0000...0000'}`, successMessage: "Transaction details retrieved successfully!" }));
}
