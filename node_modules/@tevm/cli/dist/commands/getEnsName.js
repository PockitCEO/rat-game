...
export default function GetEnsName({ options }) {
    // Use the action hook
    ...
    const shortAddress = actionResult.options['address']
        ...
        : '0xd8dA...6045';
    return (_jsx(CliAction, { ...actionResult, targetName: `address ${shortAddress}`, successMessage: "ENS name retrieved successfully!" }));
}
