...
export default function SetCode({ options }) {
    // Use the action hook
    ...
    return (_jsx(CliAction, { ...actionResult, targetName: `contract at ${actionResult.options['address'] || '0x0000...0000'}`, successMessage: "Contract bytecode set successfully!" }));
}
