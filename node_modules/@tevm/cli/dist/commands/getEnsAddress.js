...
export default function GetEnsAddress({ options }) {
    // Use the action hook
    ...
    return (_jsx(CliAction, { ...actionResult, targetName: `ENS name ${actionResult.options['name'] || 'vitalik.eth'}`, successMessage: "ENS address resolved successfully!" }));
}
