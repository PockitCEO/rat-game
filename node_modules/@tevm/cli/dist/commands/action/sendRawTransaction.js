...
export default function SendRawTransaction({ options }) {
    // Use the action hook
    ...
    return (_jsx(CliAction, { ...actionResult, targetName: "serialized transaction", successMessage: "Transaction sent successfully!" }));
}
