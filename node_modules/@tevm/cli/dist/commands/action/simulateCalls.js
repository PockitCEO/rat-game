...
export default function SimulateCalls({ options }) {
    // Use the action hook
    ...
    return (_jsx(CliAction, { ...actionResult, targetName: `${(actionResult.options['calls'] || []).length} calls`, successMessage: "Calls simulated successfully!" }));
}
