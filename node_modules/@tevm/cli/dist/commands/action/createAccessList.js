...
export default function CreateAccessList({ options }) {
    // Use the action hook
    ...
    return (_jsx(CliAction, { ...actionResult, targetName: `transaction to ${actionResult.options['to'] || '0x7099...c8'}`, successMessage: "Access list created successfully!" }));
}
