...
export default function GetBalance({ options }) {
    // Use the action hook
    ...
    const shortAddress = actionResult.options['address']
        ...
        : '0xA0Cf...251e';
    return (_jsx(CliAction, { ...actionResult, targetName: `address ${shortAddress}`, successMessage: "Balance retrieved successfully!" }));
}
