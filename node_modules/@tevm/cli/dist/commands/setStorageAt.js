...
export default function SetStorageAt({ options }) {
    // Use the action hook
    ...
    return (_jsx(CliAction, { ...actionResult, targetName: `storage slot ${actionResult.options['index'] || '0x0'} at ${actionResult.options['address'] || '0x0000...0000'}`, successMessage: "Storage value set successfully!" }));
}
