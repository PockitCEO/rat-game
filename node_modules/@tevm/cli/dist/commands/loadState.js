...
export default function LoadState({ options }) {
    ...
    return _jsx(CliAction, { ...actionResult, targetName: "load state", successMessage: "State loaded successfully!" });
}
