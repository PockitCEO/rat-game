...
export const options = z.object({
    ...
    // Contract parameters
    abi: z.string().describe(option({
        description: optionDescriptions.abi,
    })),
    functionName: z.string().describe(option({
...
export default function Contract({ options }) {
    ...
    const actionResult = useAction({
        ...
        createParams: (enhancedOptions) => {
            ...
            const to = enhancedOptions['to'];
            const code = enhancedOptions['code'];
            const deployedBytecode = enhancedOptions['deployedBytecode'];
    ...
    return (_jsx(CliAction, { ...actionResult, targetName: `contract ${actionResult.options['to'] || 'code'} function ${actionResult.options['functionName']}`, successMessage: "Contract function called successfully!" }));
}
