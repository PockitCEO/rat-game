...
export default function EstimateGas({ options }) {
    // Use the action hook
    ...
    return (_jsx(CliAction, { ...actionResult, targetName: `transaction to ${actionResult.options['to'] || '0x0000...0000'}`, successMessage: "Gas estimation completed successfully!" }));
}
