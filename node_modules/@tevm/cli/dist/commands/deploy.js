...
export const options = z.object({
    ...
    // Contract parameters
    bytecode: z.string().describe(option({
...
export default function Deploy({ options }) {
    ...
    const actionResult = useAction({
        ...
        createParams: (enhancedOptions) => {
            const bytecode = enhancedOptions['bytecode'];
    ...
    return (_jsx(CliAction, { ...actionResult, targetName: "contract deployment", successMessage: "Contract deployed successfully!" }));
}
