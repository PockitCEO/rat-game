...
export default function SetNonce({ options }) {
    // Use the action hook
    ...
    return (_jsx(CliAction, { ...actionResult, targetName: `account ${actionResult.options['address'] || '0x0000...0000'}`, successMessage: "Account nonce set successfully!" }));
}
