import { anvil, arbitrum, arbitrumSepolia, avalanche, base, blast, bsc, gnosis, mainnet, moonbeam, optimism, optimismGoerli, optimismSepolia, polygon, scroll, sepolia, tevmDefault, zksync, } from '@tevm/common';
import { http } from '@tevm/jsonrpc';
import { createMemoryClient } from '@tevm/memory-client';
import { createServer } from '@tevm/server';
import { createLoggingRequestProxy } from '../stores/logStore.js';
export async function initializeServer({ port, host, chainId, verbose, fork, }) {
    const chains = {
        [base.id]: base,
        [mainnet.id]: mainnet,
    ...
    if (!chain) {
        throw new Error(`Unknown chain id: ${chainId}. Valid chain ids are ${Object.entries(chains)
