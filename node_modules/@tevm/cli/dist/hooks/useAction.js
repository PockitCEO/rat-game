 ...
 */
export const envVar = (name, prefix = 'TEVM_') => {
 ...
 */
export function useAction({ actionName, options, defaultValues, optionDescriptions, executeAction, createParams, }) {
    ...
    const projectDirRef = React.useRef(null);
    ...
    const { data: interactiveResult, isLoading: isInteractiveLoading, error: interactiveError, } = useQuery({
    ...
    const { isLoading: isActionLoading, error: actionError, data: result, } = useQuery({
