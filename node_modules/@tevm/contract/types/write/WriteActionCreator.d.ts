import type { AbiParametersToPrimitiveTypes, Address, ExtractAbiFunction, ExtractAbiFunctionNames, FormatAbi, Hex, ParseAbi } from '@tevm/utils';
/**
 ...
 * ```
 */
export type WriteActionCreator<THumanReadableAbi extends readonly string[], TAddress extends Address | undefined, TCode extends Hex | undefined, TAddressArgs = TAddress extends undefined ? {} : {
    address: TAddress;
    to: TAddress;
}> = {
...
//# sourceMappingURL=WriteActionCreator.d.ts.map