...
import { formatAbi, parseAbi, getAddress } from '@tevm/utils';

// src/createContract.js
var eventsFactory = ({ events, bytecode, deployedBytecode, address }) => Object.fromEntries(
  events.map((eventAbi) => {
...
var readFactory = ({ methods, errors, address, code }) => Object.fromEntries(
  methods.filter(({ type }) => type === "function").filter((method) => {
    const abiFunction = (
      /** @type {import('@tevm/utils').AbiFunction} */
      method
    );
    ...
    const creator = (...args) => {
      const methodAbi = methods.filter(
        (m) => (
          /**@type {import('@tevm/utils').AbiFunction}*/
          m.name === /**@type {import('@tevm/utils').AbiFunction}*/
          method.name
        )
      ).concat(errors);
      ...
      return {
        ...
        ...code !== void 0 ? { code } : {},
        ...address !== void 0 ? { address, to: address } : {},
        ...maybeArgs
      };
    };
    creator.abi = [method];
...
var writeFactory = ({ methods, errors, address, code }) => Object.fromEntries(
  methods.filter(({ type }) => type === "function").filter((method) => {
    const abiFunction = (
      /** @type {import('@tevm/utils').AbiFunction} */
      method
...
var createContract = ({
  ...
  const optionalArgs = {
    ...address !== void 0 ? { address: getAddress(address) } : {},
    ...code !== void 0 ? { code } : {},
    ...bytecode !== void 0 ? { bytecode } : {},
...
// src/contract-lib/AdvancedContract.s.sol.ts
...
var AdvancedContract = createContract(_AdvancedContract);
var _MathHelper = {
  name: "MathHelper",
  humanReadableAbi: [
...
createContract(_MathHelper);

// src/contract-lib/ERC20.ts
var _OzERC20 = {
  name: "OzERC20",
  humanReadableAbi: [
...
var ERC20 = createContract(_OzERC20);

// src/contract-lib/ERC721.ts
var _OzERC721 = {
  name: "OzERC721",
  humanReadableAbi: [
    "constructor(string name, string symbol)",
...
var ERC721 = createContract(_OzERC721);

// src/contract-lib/ErrorContract.s.sol.ts
var _ErrorContract = {
  name: "ErrorContract",
  humanReadableAbi: [
...
var ErrorContract = createContract(_ErrorContract);

// src/contract-lib/SimpleContract.s.sol.ts
var _SimpleContract = {
  name: "SimpleContract",
  humanReadableAbi: [
...
var SimpleContract = createContract(_SimpleContract);

export { AdvancedContract, ERC20, ERC721, ErrorContract, SimpleContract, createContract };
