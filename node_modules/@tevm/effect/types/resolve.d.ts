...
export type ResolveSafe = (arg0: string, arg1: import("resolve").SyncOpts & import("resolve").AsyncOpts) => import("effect/Effect").Effect<string, CouldNotResolveImportError, never>;
