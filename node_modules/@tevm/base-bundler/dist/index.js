...
var resolveModuleAsync = async (logger, config, fao, solc, modulePath, basedir, includeAst, includeBytecode, moduleType, cache, contractPackage) => {
  ...
  try {
    const { solcInput, solcOutput, asts, artifacts, modules } = cachedResult ?? await resolveArtifacts(modulePath, basedir, logger, config, includeAst, includeBytecode, fao, solc);
    let code = "";
