import type { CallJsonRpcRequest, CallResult, DumpStateJsonRpcRequest, DumpStateResult, GetAccountJsonRpcRequest, GetAccountResult, LoadStateJsonRpcRequest, LoadStateResult, SetAccountJsonRpcRequest, SetAccountResult } from '@tevm/actions';
