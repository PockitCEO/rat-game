 ...
 */
export type TraceParams<TTracer extends 'callTracer' | 'prestateTracer' | '4byteTracer' | undefined = 'callTracer' | 'prestateTracer' | '4byteTracer' | undefined, TDiffMode extends boolean = boolean> = {
    /**
     * The type of tracer
 ...
 */
export type DebugTraceTransactionParams<TTracer extends 'callTracer' | 'prestateTracer' | '4byteTracer' | undefined = 'callTracer' | 'prestateTracer' | '4byteTracer' | undefined, TDiffMode extends boolean = boolean, TTTThrowOnError extends boolean = boolean> = BaseParams<TTTThrowOnError> & TraceParams<TTracer, TDiffMode> & {
    /**
 ...
 */
export type DebugTraceCallParams<TTracer extends 'callTracer' | 'prestateTracer' | '4byteTracer' | undefined = 'callTracer' | 'prestateTracer' | '4byteTracer' | undefined, TDiffMode extends boolean = boolean> = TraceParams<TTracer, TDiffMode> & EthCallParams;
/**
 * Params taken by `debug_traceBlock` handler
 */
export type DebugTraceBlockParams<TTracer extends 'callTracer' | 'prestateTracer' | '4byteTracer' | undefined = 'callTracer' | 'prestateTracer' | '4byteTracer' | undefined, TDiffMode extends boolean = boolean> = TraceParams<TTracer, TDiffMode> & ExactlyOne<{
    /**
