 ...
 */
export type DebugTraceTransactionResult<TTracer extends 'callTracer' | 'prestateTracer' | '4byteTracer' | undefined = 'callTracer' | 'prestateTracer' | '4byteTracer' | undefined, TDiffMode extends boolean = boolean> = TTracer extends 'callTracer' ? CallTraceResult : TTracer extends 'prestateTracer' ? PrestateTraceResult<TDiffMode> : TTracer extends '4byteTracer' ? FourbyteTraceResult : TraceResult;
/**
 * Result from `debug_traceCall`
 */
export type DebugTraceCallResult<TTracer extends 'callTracer' | 'prestateTracer' | '4byteTracer' | undefined = 'callTracer' | 'prestateTracer' | '4byteTracer' | undefined, TDiffMode extends boolean = boolean> = TTracer extends 'callTracer' ? CallTraceResult : TTracer extends 'prestateTracer' ? PrestateTraceResult<TDiffMode> : TTracer extends '4byteTracer' ? FourbyteTraceResult : TraceResult;
/**
 * Result from `debug_traceBlock`.
 *
 * Returns an array of transaction traces
 */
export type DebugTraceBlockResult<TTracer extends 'callTracer' | 'prestateTracer' | '4byteTracer' | undefined = 'callTracer' | 'prestateTracer' | '4byteTracer' | undefined, TDiffMode extends boolean = boolean> = Array<{
    /**
     * Transaction hash
     */
    txHash: Hex;
