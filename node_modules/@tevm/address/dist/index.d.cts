 ...
 */
declare class Address extends EthjsAddress {
}

declare function create2ContractAddress(from: EthjsAddress, salt: _tevm_utils.Hex, code: _tevm_utils.Hex): Address;
type Create2ContractAddressError = _tevm_errors.InvalidSaltError | _tevm_errors.InvalidAddressError;

declare function createAddress(address: _tevm_utils.AddressLike | number | bigint | string): Address;

declare function createContractAddress(from: EthjsAddress, nonce: bigint): Address;

export { Address, type Create2ContractAddressError, create2ContractAddress, createAddress, createContractAddress };
