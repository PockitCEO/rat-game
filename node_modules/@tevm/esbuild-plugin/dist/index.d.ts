...
import * as _tevm_unplugin from '@tevm/unplugin';
 ...
 */
declare const esbuildPluginTevm: (options?: {
    solc?: _tevm_unplugin.CompilerOption;
} | undefined) => unplugin.EsbuildPlugin;

export { esbuildPluginTevm };
