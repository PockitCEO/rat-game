...
import { mainnet as mainnet$1, optimism as optimism$1 } from 'viem/chains';

// src/BlockReader.s.sol.ts
var _BlockReader = {
  name: "BlockReader",
...
var BlockReader = createContract(_BlockReader);
var _ErrorContract = {
  name: "ErrorContract",
  humanReadableAbi: [
...
var TestERC20 = createContract(_TestERC20);
var _TestERC721 = {
  name: "TestERC721",
  humanReadableAbi: [
    "constructor(string name, string symbol)",
...
var TestERC721 = createContract(_TestERC721);
var _SimpleContract = {
  name: "SimpleContract",
  humanReadableAbi: [
...
var mainnet = loadBalance(
  mainnetRpcUrls.map((url) => rateLimit(http(url), { browser: false, requestsPerSecond: 150 }))
)({ retryCount: 3, chain: mainnet$1 });
var optimism = loadBalance(
  optimismRpcUrls.map((url) => rateLimit(http(url), { browser: false, requestsPerSecond: 150 }))
)({ retryCount: 3, chain: optimism$1 });
var transports = {
  mainnet,
  optimism
};

export { BlockReader, ErrorContract, SimpleContract, TestERC20, TestERC721, getAlchemyUrl, transports };
